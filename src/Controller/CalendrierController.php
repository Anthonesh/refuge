...
class CalendrierController extends AbstractController
{
    ...
    public function index(CalendrierRepository $calendrierRepository, PensionnairesRepository $pensionnairesRepository,): Response
    {
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, PensionnairesRepository $pensionnairesRepository,): Response
    {
